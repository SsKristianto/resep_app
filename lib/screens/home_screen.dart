import 'package:resep/screens/detail_screen.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          BottomNavigationBarItem(
            ...
            label: Text("Home").data, // Extract the text content
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.fastfood),
            label: Text("Recipes").data, // Extract the text content
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.bookmark),
            label: "Bookmark", // Pass the string directly
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.settings),
            label: "Settings", // Pass the string directly
          ),
        ],
        iconSize: 30,
